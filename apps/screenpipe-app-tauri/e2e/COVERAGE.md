...
- Mapped specs: 98
- Declared test blocks: 267
- Weighted coverage points: 206.7
...
| chat-ai | 23 specs / 37 tests / 28.1 pts | 32 specs / 55 tests / 38.7 pts | 22 specs / 36 tests / 27.6 pts |
| entitlement | - | 1 specs / 1 tests / 1.0 pts | - |
| local-api | 20 specs / 104 tests / 86.8 pts | 24 specs / 87 tests / 73.4 pts | 16 specs / 75 tests / 66.2 pts |
...
| pipes | 6 specs / 18 tests / 18.0 pts | 7 specs / 22 tests / 22.0 pts | 6 specs / 18 tests / 18.0 pts |
| real-ui-e2e | 53 specs / 147 tests / 120.0 pts | 62 specs / 145 tests / 118.1 pts | 49 specs / 125 tests / 106.4 pts |
| settings | 14 specs / 37 tests / 34.0 pts | 16 specs / 32 tests / 27.7 pts | 13 specs / 29 tests / 26.0 pts |
| storage-privacy | 9 specs / 39 tests / 30.3 pts | 9 specs / 24 tests / 23.1 pts | 6 specs / 18 tests / 17.1 pts |
...
| pipe-continuous-chat.spec.ts | macos | pipes, chat-ai, real-ui-e2e, local-api, storage-privacy | pipes, chat | high | strong | real-user-flow | 4 | Four native desktop journeys cover failed-save rollback and retry, stable one-chat continuity across real Pipe runs, a human follow-up carried into the next scheduled run, and confirmed reset followed by a clean run without prior scheduled or human context. |
