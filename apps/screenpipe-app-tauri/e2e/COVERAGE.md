...
- Weighted coverage points: 195.5
...
| --- | --- | --- | --- | --- | --- | --- |
| windows | 73 | 226 | 182.0 | 15 | 77 | 91% |
| macos | 87 | 217 | 166.3 | 17 | 79 | 89% |
| linux | 63 | 186 | 151.8 | 14 | 72 | 88% |
...
| onboarding | 3 specs / 9 tests / 5.4 pts | 3 specs / 9 tests / 5.4 pts | 3 specs / 9 tests / 5.4 pts |
...
| real-ui-e2e | 50 specs / 143 tests / 114.8 pts | 55 specs / 132 tests / 106.9 pts | 46 specs / 121 tests / 101.2 pts |
| settings | 14 specs / 37 tests / 34.0 pts | 16 specs / 32 tests / 27.7 pts | 13 specs / 29 tests / 26.0 pts |
| storage-privacy | 9 specs / 39 tests / 29.1 pts | 8 specs / 20 tests / 17.9 pts | 6 specs / 18 tests / 15.9 pts |
...
| onboarding-background-ai-tools.spec.ts | windows, macos, linux | onboarding, real-ui-e2e, storage-privacy | onboarding, settings-ai | high | conditional | real-user-flow | 2 | Opt-in isolated agent-home lane verifies native authenticated MCP plus skills setup and removal of the connection slide. |
