...
| `settings-sections.spec.ts` | Navigates General → Recording → AI Presets → Other AI Settings → Speakers; verifies moved controls, enabled/disabled analysis flows, content, and no crash |
