...
curl -H "Authorization: Bearer $SCREENPIPE_API_KEY" \
  "http://localhost:3030/search?limit=20&content_type=all&start_time=2026-05-14T00:00:00Z"
```
...
```bash
curl -H "Authorization: Bearer $SCREENPIPE_API_KEY" \
  "http://localhost:3030/search?q=deployment&app_name=Slack&limit=20&start_time=2026-05-14T00:00:00Z"
curl -H "Authorization: Bearer $SCREENPIPE_API_KEY" \
  "http://localhost:3030/search?browser_url=github.com&limit=20&start_time=2026-05-14T00:00:00Z"
```
...
```bash
curl -H "Authorization: Bearer $SCREENPIPE_API_KEY" \
  "http://localhost:3030/search?start_time=2026-05-14T09:00:00Z&end_time=2026-05-14T12:00:00Z&limit=50"
```
...
```bash
curl -H "Authorization: Bearer $SCREENPIPE_API_KEY" \
  "http://localhost:3030/search?q=budget&content_type=audio&limit=20&start_time=2026-05-14T00:00:00Z"
curl -H "Authorization: Bearer $SCREENPIPE_API_KEY" \
  "http://localhost:3030/search?content_type=audio&speaker_name=Sarah&limit=20&start_time=2026-05-14T00:00:00Z"
```
...
```bash
curl -H "Authorization: Bearer $SCREENPIPE_API_KEY" \
  "http://localhost:3030/activity-summary?start_time=2026-05-14T16:00:00Z&end_time=2026-05-14T18:00:00Z"
```
