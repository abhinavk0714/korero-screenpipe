...
export interface Env {
	...
	HOSTED_AI_INCLUDED_CREDITS_FREE?: string;
	HOSTED_AI_INCLUDED_CREDITS_BASIC?: string;
	HOSTED_AI_INCLUDED_CREDITS_BUSINESS?: string;
	HOSTED_AI_INCLUDED_CREDITS_BUSINESS_MAX?: string;
	HOSTED_AI_INCLUDED_CREDITS_BUSINESS_ULTRA?: string;
	HOSTED_AI_TRIAL_INCLUDED_CREDITS?: string;
